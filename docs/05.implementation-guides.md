...
tags:
  ...
  - fhir
private: false
updated_at: '2024-07-21T14:13:07Z'
id: null
...
```bash
curl -o resources/04-jp-core-patient-example.json https://jpfhir.jp/fhir/core/1.1.2/Patient-jp-patient-example-1.json
```
...
```bash
curl -o resources/06-medication-request-example.json https://jpfhir.jp/fhir/core/1.1.2/MedicationRequest-jp-medicationrequest-example-2.json
```
